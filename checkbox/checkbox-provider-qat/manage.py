...
setup(
    name='com.canonical.certification:intel-qat',
    version="1.0",
    description=N_("The com.canonical.certification:intel-qat provider"),
    gettext_domain="com_canonical_certification_intel-qat",
)
